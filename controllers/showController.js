...
module.exports.deleteShow = async (req, res) => {
  try {
    ...
    if (findMovie) {
      ...
      console.warn("deleteShow: Movie not found for movieId:", movieId);
    }

    // Cascade delete any bookings tied to this show to avoid orphan bookings
    await Booking.deleteMany({ showId });
